...
import { Menu, User, Mail, Phone, Camera, Save, AlertCircle, Loader, CheckCircle, Sprout, Coins, CreditCard, Plus } from 'lucide-react';
        ...
        <div className="p-4 lg:p-6 space-y-5 max-w-7xl mx-auto">
          ...
          >
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="text-sm font-bold text-gray-900 dark:text-white">Wallet</h3>
            </div>
            <div className="flex items-center gap-3 mb-4">
              <span className="text-3xl font-bold text-gray-900 dark:text-white">{coins !== null ? coins : 0}</span>
              <span className="text-xs text-gray-500">coins available</span>
            </div>
            <div className="flex flex-wrap items-center gap-3">
              {[1, 10, 50, 100, 200, 500].map((amt) => (
                <button
                  key={amt}
              ...
              <div className="flex items-center gap-2">
                ...
                <input
                  ...
                  className="w-20 px-3 py-2 rounded-xl bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 text-xs text-gray-900 dark:text-white outline-none focus:border-emerald-500"
                />
              </div>
              <Button onClick={handleRecharge} disabled={recharging || !rechargeAmount || rechargeAmount < 1} icon={recharging ? null : Plus}>
                {recharging ? <Loader size={14} className="animate-spin" /> : null}
